    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מתלבט בין Avivi Solutions לבין BoostAI משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c5986b1e-4752-4f09-a18d-bfc114f0b8ea',
                    name: data.name || '',
                    email: data.email || '',
